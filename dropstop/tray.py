...
from dropstop.icon import generate_running_icon, generate_paused_icon


class DropStopTray:
    """System tray icon for DropStop."""
    ...
    def start(self):
        ...
        self._icon = pystray.Icon(
            ...
            title="DropStop - Dropbox Pause Utility",
    ...
    def notify(self, message, title="DropStop"):
    ...
    def _get_current_icon(self):
        """Return green or red icon based on current state."""
        if self.app.timer_mgr.is_paused:
            return generate_paused_icon(size=64)
        return generate_running_icon(size=64)
    ...
    def _build_menu(self):
        ...
        return Menu(
            ...
            Menu.SEPARATOR,
            MenuItem("Resume Dropbox", self._on_resume),
            Menu.SEPARATOR,
            MenuItem(
                "Notifications",
    ...
    def _on_toggle_notifications(self, icon, item):
        ...
        from dropstop.config import save_config
